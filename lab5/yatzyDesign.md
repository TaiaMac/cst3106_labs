...
### Colors Palette
- Primary Color: #000000d8 - Used for headings, buttons, and dice.
- Secondary Color: #811212d2 - Used for background and highlights.
- Tertiary Color: #e3ce2dff - Used for text and secondary elements.
